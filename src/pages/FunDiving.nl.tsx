              ...
              <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <CardContent>
                    ...
                    <ul className="list-disc pl-5 text-sm mb-4">
                      ...
                      <li>Maximaal 4 duikers per gids</li>
                          ...
                          <Button variant="secondary" onClick={() => { window.open('/booking?item=Fun%20Dive&type=dive&price=1800&currency=THB&dives=2', '_blank', 'noopener'); }}>Info / Boeken</Button>
                  </CardContent>
                </Card>
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button variant="secondary" onClick={() => { window.open('/booking?item=Discover%20Scuba&type=dive&price=2500&currency=THB', '_blank', 'noopener'); }}>Info / Boeken</Button>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent>
                    ...
                    <Button variant="secondary" onClick={() => { window.open('/booking?item=Sail%20Rock%20Special&type=dive&price=2900&currency=THB', '_blank', 'noopener'); }}>Info / Boeken</Button>
                  </CardContent>
                </Card>
              </div>
            </div>
